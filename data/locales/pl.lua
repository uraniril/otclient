locale = {
  ...
  translation = {
    ...
    ["Alas! Brave adventurer, you have met a sad fate.\nBut do not despair, for the gods will bring you back\ninto this world in exchange for a small sacrifice\n\nSimply click on Ok to resume your journeys!"] = "Niestety! Dzielny podrozniku, spotkal cie smutny los.\nLecz nie rozpaczaj, bogowie przywroca cie\ndo zywych w zamian za niewielka ofiare.\n\nWcisnij Ok aby kontynuowac podroz!",
    ["All"] = "Wszystkie",
    ["All modules and scripts were reloaded."] = "Wszystkie moduly zostaly przeladowane",
    ["Allow auto chase override"] = "Zezwol na przerwanie pogoni",
    ["Also known as dash in tibia community, recommended\nfor playing characters with high speed"] = "Znany rowniez jako dash, zalecany\ndla postaci o duzej predkosci",
    ["Ambient light: %s%%"] = "Swiatlo otoczenia: %s%%",
    ["Amount:"] = "Ilosc:",
    ["Amount"] = "Ilosc",
    ["Anonymous"] = "Anonimowy",
    ["Are you sure you want to logout?"] = "Jestes pewien, ze sie chcesz wylogowac?",
    ["Attack"] = "Atak",
    ["Author"] = "Autor",
    ...
    ["Balance:"] = "Stan konta:",
    ["Banishment"] = "Zbanuj",
    ["Banishment + Final Warning"] = "Ban + Ostatnie Ostrzezenie",
    ["Battle"] = "Bitwa",
    ["Browse"] = "Przegladaj",
    ...
    ["Current hotkeys:"] = "Aktualny skrot:",
    ["Current hotkey to add: %s"] = "Aktualny skrot do dodania: %s",
    ...
    ["Edit hotkey text:"] = "Edytuj tresc skrotu:",
    ...
    ["Enable walk booster"] = "Wlacz wzmocnienie chodzenia",
    ...
    ["Exclude from private chat"] = "Wyrzuc z prywatnej konwersacji",
    ["Exit"] = "Wyjdz",
    ...
    ["Hit Points"] = "Punkty Zdrowia",
    ["Hold left mouse button to navigate\nScroll mouse middle button to zoom\nRight mouse button to create map marks"] = "Przytrzymaj lewy przycisk myszy by przewinac mape\nUzyj kolka myszy aby przyblizyc\nWcisnij prawy przycisk by utworzyc znacznik",
    ...
    ["Level"] = "Poziom",
    ["Lifetime Premium Account"] = "Dozywotnie Konto Premium",
    ...
    ["Mana"] = "Mana",
    ["Manage hotkeys:"] = "Zarzadzaj skrotami:",
    ["Market"] = false,
    ...
    ["Name:"] = "Nazwa:",
    ["Name Report"] = "Zglos Imie",
    ["Name Report + Banishment"] = "Zglos Imie + Zbanuj",
    ["Name Report + Banishment + Final Warning"] = "Zglos Imie + Zbanuj + Ostatnie Ostrzezenie",
    ["No"] = "Nie",
    ...
    ["No statement has been selected."] = "Nie wybrano wypowiedzi.",
    ["Notation"] = "Upomnienie",
    ...
    ["Please enter a character name"] = "Wpisz nazwe postaci",
    ...
    ["Please use this dialog to only report bugs. Do not report rule violations here!"] = "Uzywaj tego okna tylko do zglaszania bledow gry. Nie zglaszaj tu lamania zasad!",
    ...
    ["Randomize"] = "Losuj",
    ["Randomize characters outfit"] = "Wybierz losowy stroj",
    ["Reason:"] = "Powod:",
    ["Refresh"] = "Odswiez",
    ...
    ["Show event messages in console"] = "Pokaz zdarzenia w konsoli",
    ["Show frame rate"] = "Pokaz FPS",
    ["Show info messages in console"] = "Pokaz informacje w konsoli",
    ["Show left panel"] = "Pokaz lewy panel",
    ["Show levels in console"] = "Pokaz poziom graczy w konsoli",
    ["Show Offline"] = "Pokaz Wylogowanych",
    ...
    ["Show timestamps in console"] = "Pokaz czas w konsoli",
    ...
    ["Trade"] = "Wymiana",
    ["Trade with ..."] = "Wymien z ...",
    ["Trying to reconnect in %s seconds."] = "Proba ponownego polaczenia za %s sekund.",
    ...
    ["Unable to logout."] = "Nie mozna wylogowac.",
    ["Unignore"] = "Przestan Ignorowac",
    ["Unload"] = "Wylacz",
    ...
    ["Website"] = "Strona:",
    ["Weight:"] = "Waga:",
    ["Will detect when to use diagonal step based on the\nkeys you are pressing"] = "Wykryje kiedy zrobic krok po skosie na podstawie\nwcisnietych klawiszy",
    ...
    ["You have %s percent to go"] = "Brakuje %s procent",
    ["You may not logout during a fight"] = "Nie mozesz wylogowac w trakcie walki",
    ["You may not logout or enter a protection zone"] = "Nie mozesz wylogowac ani wejsc do strefy ochronnej",
    ["You must enter a comment."] = "Musisz wprowadzic komentarz",
    ["You must enter a valid server address and port."] = "Musisz wprowadzic poprawny adres i port.",
    ...
    ["You read the following, written on \n%s.\n"] = "Czytasz nastepujace, napisane o \n%s.\n",
    ...
    ["Display creature names"] = "Wyswietlaj nazwy postaci",
    ["Display creature health bars"] = "Wyswietlaj paski zdrowia",
    ...
    ["Host"] = false,
    ["Reset All"] = "Resetuj",
    ["Disable chat mode, allow to walk using ASDW"] = "Zablokuj czat, zezwol na poruszanie sie za pomoca klawiszy ADSW",
    ["Name"] = "Imie",
    ["Price"] = "Cena",
    ["Your Money"] = "Twoje pieniadze",
    ["Weight"] = "Waga",
    ...
    ["Paladin"] = "Paladyn",
    ["Knight"] = "Rycerz",
    ["Destination is out of range."] = "Cel poza zasiegiem.",
	["Floor Shadowing"] = "Cieniowanie Podlogi",
	["Draw Viewport Edge"] = "Pokaz Krawedz Okna Gry",
	["Draw Floating Effects"] = "Pokaz Wiszace Efekty",
	["Light Version"] = "Wersja Oswietlenia",
	["Render Scale"] = "Skala Renderowania",
	["Warning"] = "Ostrzezenie",
	["Rendering scale above 100%% will drop performance and visual bugs may occur."] = "Skala renderowania powyzej 100%% moze powodowac bledy wizualne oraz spadki wydajnosci."
  }
}
