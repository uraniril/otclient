...
function Player:toggleMount() g_game.mount(not self:isMounted()) end

function Player:mount() g_game.mount(true) end

function Player:dismount() g_game.mount(false) end
